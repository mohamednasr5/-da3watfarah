...
var VipTemplateRenderer = (function () {
 ...
 dateTimeISO = d.getFullYear() + '-' +
        ...
        return {
            ...
            groomName: name1 || undefined,
            brideName: name2 || undefined,
            groomFamily: couple.parentsNames || (couple.groomFatherName ? ('عائلة ' + couple.groomFatherName) : undefined),
            brideFamily: couple.brideFatherName ? ('عائلة ' + couple.brideFatherName) : undefined,
            eventDateDisplay: dateDisplay || undefined,
            eventDateTime: dateTimeISO || undefined,
            ...
            welcomeText: content.welcomeText || undefined,
